...
function UpdateRoomBooking() {
  ...
  const [roomType, setRoomType] = useState("Diplomat");
      ...
      {receipt && (
        <div className="mt-5">
          ...
          <ul>
            ...
            <li>
              <strong>Room Type:</strong> {receipt.roomType}
            </li>
            <li>
              <strong>From:</strong> {receipt.startDate}
            </li>
            <li>
              <strong>To:</strong> {receipt.endDate}
            </li>
            <li>
              <strong>Number of Rooms:</strong> {receipt.amount}
            </li>
            <li>
              <strong>Breakfast:</strong>{" "}
              {receipt.breakfast ? "Yes (฿10)" : "No"}
            </li>
            <li>
